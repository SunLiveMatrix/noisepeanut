...
#else
#define     get_reference_nocode_iasten as wstring
#define     get_reference_nocode_buttons as wstring
#define     get_reference_nocode_states as wstring
#define     get_reference_nocode_ablility as wstring
#define     get_reference_nocode_caps as wstring
#define     get_reference_nocode_machines as wstring
#define     get_reference_nocode_effects as wstring
#define     get_reference_nocode_netbeans as wstring
#define     get_reference_nocode_editors as wstring
#define     get_reference_nocode_freebasic as wstring
#define     get_reference_nocode_dlang as wstring
#define     get_reference_nocode_raku as wstring
#define     get_reference_nocode_c as wstring
#define     get_reference_nocode_stability as wstring
#define     get_reference_nocode_fbc as wstring
#define     get_reference_nocode_mits as wstring
#define     get_reference_nocode_mentor as wstring
#define     get_reference_nocode_work as wstring
#define     get_reference_nocode_jobs as wstring
#define     get_reference_nocode_separater as wstring
#define     get_reference_nocode_changes as wstring
#define     get_reference_nocode_bluetooth as wstring
#define     get_reference_nocode_blueeditor as wstring
#endif
end

sub get_reference_nocode()
    type reference_nocode alias "get_reference_nocode_machines"
         reference_nocode_home as long
    end type      
end sub


sub get_reference_nocode_local(byref machines as wstring)
   type reference_nocode alias "get_reference_nocode_machines"
        reference_nocode_home as long
   end type     
end sub    
